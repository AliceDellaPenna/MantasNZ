...
# Plot smooth component estimates with confidence intervals using ggplot2
# Your ggplot code
d <- ggplot(sm_d, aes(y = est, x = wind_dir)) +
  geom_rug(data = gam_d_df, mapping = aes(x = wind_dir), sides = "b", inherit.aes = FALSE) +
  geom_ribbon(aes(ymin = lower_ci, ymax = upper_ci),
              alpha = 0.2, fill = "#caa7cf", colour = "#caa7cf", linetype = "dashed") +  # Add dashed border
  geom_line(colour = "#caa7cf", size = 1.5) +
  labs(y = NULL,
...
e <- ggplot(sm_d, aes(y = est, x = wind_speed)) +
  ...
  scale_x_continuous(limits = c(2, 16.9)) +
  theme_minimal() +
  theme(panel.background = element_blank(),  # Remove panel background
        panel.grid.major = element_blank(),  # Remove major grid lines
        panel.grid.minor = element_blank(),  # Remove minor grid lines
...
f <- ggplot(sm_d, aes(y = est, x = altitude)) +
  ...
  labs(y = NULL,
       x = "Altitude (°)") +
  coord_cartesian(ylim = c(-0.5, 0.5)) +  # Adjust y-axis limits
  theme_minimal() +
  theme(panel.background = element_blank(),  # Remove panel background
        panel.grid.major = element_blank(),  # Remove major grid lines
        panel.grid.minor = element_blank(),  # Remove minor grid lines
...
### SEX -----------------------------------------------------------------------
# Plot the parametric effects with circles and error bars
h <- ggplot(sex_effects_d, aes(x = level, y = partial)) +
  geom_errorbar(aes(ymin = partial - se, ymax = partial + se), width = 0.2, size = 1) +  # Error bars
  geom_point(shape = 21, size = 5, fill = "black") +  # Circle for the partial effect
  labs(x = "Sex", y = NULL) +
  coord_cartesian(ylim = c(-1, 1)) +  # Adjust y-axis limits
...
### ID -------------------------------------------------------------------------
# Plot the parametric effects with circles and error bars
i <- ggplot(id_effects_d, aes(x = level, y = partial)) +
  geom_errorbar(aes(ymin = partial - se, ymax = partial + se), width = 0.2, size = 1) +  # Error bars
...
combined_plot_d <- (a | b | c | d | e | f | g | h | i ) +
...
# Plot smooth component estimates with confidence intervals using ggplot2
# Your ggplot code
d <- ggplot(sm_n, aes(y = est, x = wind_dir)) +
  geom_rug(data = gam_n_df, mapping = aes(x = wind_dir), sides = "b", inherit.aes = FALSE) +
  geom_ribbon(aes(ymin = lower_ci, ymax = upper_ci),
              alpha = 0.2, fill = "#a6cee3", colour = "#a6cee3", linetype = "dashed") +  # Add dashed border
  geom_line(colour = "#a6cee3", size = 1.5) +
  labs(y = NULL,
...
# Plot smooth component estimates with confidence intervals using ggplot2
# Your ggplot code
f <- ggplot(sm_n, aes(y = est, x = moonfraction.fraction)) +
  geom_rug(data = gam_n_df, mapping = aes(x = moonfraction.fraction), sides = "b", inherit.aes = FALSE) +
  geom_ribbon(aes(ymin = lower_ci, ymax = upper_ci),
              alpha = 0.2, fill = "#a6cee3", colour = "#a6cee3", linetype = "dashed") +  # Add dashed border
  geom_line(colour = "#a6cee3", size = 1.5) +
  labs(y = NULL,
...
### SEX -----------------------------------------------------------------------
# Plot the parametric effects with circles and error bars
h <- ggplot(sex_effects_n, aes(x = level, y = partial)) +
  geom_errorbar(aes(ymin = partial - se, ymax = partial + se), width = 0.2, size = 1) +  # Error bars
  geom_point(shape = 21, size = 5, fill = "black") +  # Circle for the partial effect
  labs(x = "Sex", y = NULL) +
  coord_cartesian(ylim = c(-1, 1)) +  # Adjust y-axis limits
...
### ID -------------------------------------------------------------------------
# Plot the parametric effects with circles and error bars
i <- ggplot(id_effects_n, aes(x = level, y = partial)) +
  geom_errorbar(aes(ymin = partial - se, ymax = partial + se), width = 0.2, size = 1) +  # Error bars
  geom_point(fill = "black", shape = 21, size = 5) +  # Circle for the partial effect
  labs(x = "PTT #", y = "Partial effect") +
...
### PLOTTING FIGURES -------------------------------------------------------------------------
# Combine all plots into one figure
combined_plot_n <- (a | b | c | d | e | f | g | h | i ) +
  plot_layout(ncol = 2, nrow = 5)  # Arrange plots in two columns
